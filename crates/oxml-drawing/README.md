...
|---|---|---|---|---|---|---|---|---|
| Crates.io archive: oxml-drawing | 159,703 compressed bytes, 1,121,577 member bytes, 24 members | 0.12.1 | macOS 26.6.2, Apple M5 Max, arm64 | `cargo package --locked --no-verify` | Tracked `oxml-drawing` package inventory | `python3 scripts/readme_doctests.py --record-measurements` | gzip archive bytes, tar member bytes, tar member count | 2026-09-19 |
